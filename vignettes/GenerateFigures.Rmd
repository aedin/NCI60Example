...
# loading data
```{r loadData}
## Exists at "https://github.com/mengchen18/NCI60Example/raw/master/nci60.RDA"
#load("../data/nci60.RDA")
data(nci60)
```
